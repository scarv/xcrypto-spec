...
\XCINSTR{xc.ldr.bu}{rd, rs1, rs2}{
  Load a      byte from memory
  into a  $\GPR$ register,
  zero extending to \XLEN bits.
...
\XCINSTR{xc.ldr.b}{rd, rs1, rs2}{
  Load a      byte from memory
  into a  $\GPR$ register,
  sign extending to \XLEN bits.
  Instruction exists on RV32, RV64 and RV128.
}{
  $addr  \ASN \GPR[*][{\VERB[RV]{rs1}}] + \GPR[*][{\VERB[RV]{rs2}}]$ \;
...
\XCINSTR{xc.str.b}{rd, rs1, rs2}{
  Store the least significant byte of an $\GPR$ register into memory.
  Instruction exists on RV32, RV64 and RV128.
}{
  $addr  \ASN \GPR[*][{\VERB[RV]{rs1}}] + \GPR[*][{\VERB[RV]{rs2}}]$ \;
  $\MEM[*][{addr  }] \ASN \INDEX[8]{\GPR[*][{\VERB[RV]{rd}}]}{0}$ \;
}

% -----------------------------------------------------------------------------

\XCINSTR{xc.str.h}{rd, rs1, rs2}{
  ...
  $addr  \ASN \GPR[*][{\VERB[RV]{rs1}}] + \GPR[*][{\VERB[RV]{rs2}}]$ \;
  $\MEM[*][{addr+1:addr}] \ASN \INDEX[16]{\GPR[*][{\VERB[RV]{rd}}]}{0}$ \;
}
...
\XCINSTR{xc.str.w}{rd, rs1, rs2}{
  ...
  $addr  \ASN \GPR[*][{\VERB[RV]{rs1}}] + \GPR[*][{\VERB[RV]{rs2}}]$ \;
  $\MEM[*][{addri+3:addr}] \ASN \INDEX[32]{\GPR[*][{\VERB[RV]{rd}}]}{0}$ \;
}

% -----------------------------------------------------------------------------

\XCINSTR{xc.str.d}{rd, rs1, rs2}{
  ...
  $addr  \ASN \GPR[*][{\VERB[RV]{rs1}}] + \GPR[*][{\VERB[RV]{rs2}}]$ \;
  $\MEM[*][{addr+7:addr}] \ASN \INDEX[64]{\GPR[*][{\VERB[RV]{rd}}]}{0}$ \;
}
