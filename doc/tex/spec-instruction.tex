...
\XCINSTR{xc.madd.3}{(rd2, rd1), rs1, rs2, rs3}{
  ...
  $\GPR[*][{\VERB[RV]{rd1}}] \ASN \INDEX{t}{      \XLEN-1 \RANGE     0}$ \;
  $\GPR[*][{\VERB[RV]{rd2}}] \ASN \INDEX{t}{2\cdot\XLEN   \RANGE \XLEN}$ \;
}
...
\XCINSTR{xc.macc.1}{(rd2, rd1), rs1      }{
  ...
  $t                          \ASN ( \GPR[*][{\VERB[RV]{rd2}}] \CONS \GPR[*][{\VERB[RV]{rd1}}] ) \OP[][u]{+} \GPR[*][{\VERB[RV]{rs1}}]$ \;
  $\GPR[*][{\VERB[RV]{rd1}}] \ASN \INDEX{t}{      \XLEN-1 \RANGE     0}$ \;
  $\GPR[*][{\VERB[RV]{rd2}}] \ASN \INDEX{t}{2\cdot\XLEN   \RANGE \XLEN}$ \;
}
