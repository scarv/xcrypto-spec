...
\XCINSTR{xc.lut}{rd, rs1, rs2}{
  ...
  \For{$i = 0$ {\bf upto}  $\XLEN/4$}{
    $\INDEX[4]{t}{i} \ASN f( \INDEX[4]{\GPR[*][{\VERB[RV]{rd}}]}{i})$ \;
  }
  $\GPR[*][{\VERB[RV]{rd}}] \ASN t$ \;
}
...
\XCINSTR{xc.madd.3}{(rd2, rd1), rs1, rs2, rs3}{
  ...
  $\GPR[*][{\VERB[RV]{rd2}}] \ASN \INDEX{t}{      \XLEN               }$ \;
}
...
\XCINSTR{xc.macc.1}{(rd2, rd1), rs1, rs2, rs3}{
...
\XCINSTR{xc.mror}{(rd2, rd1), rs1, rs2, rs3}{
